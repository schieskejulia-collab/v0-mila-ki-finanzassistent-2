  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-7xl space-y-5 px-4 pb-28 pt-6 text-slate-950 sm:px-6 md:pb-10 lg:px-8">
      <header>
        ...
        <h1 className="mt-1 text-3xl font-black tracking-tight sm:text-4xl">Unterlagen rein.</h1>
      </header>

      <div className="grid gap-5 lg:grid-cols-[0.85fr_1.15fr]">
        <Link href="/stapel" className="flex min-h-64 flex-col justify-between rounded-[1.75rem] bg-gradient-to-br from-violet-600 to-fuchsia-600 p-5 text-white shadow-lg shadow-violet-100 sm:p-6">
        ...
        <section className="rounded-[1.75rem] bg-white p-5 shadow-sm ring-1 ring-slate-100 sm:p-6">
          <div className="flex items-start justify-between gap-4">
            <div>
